...
def train_tvae(data, embedding_dim=128, generator_dim=(256, 256), discriminator_dim=(256, 256), pac=10):
    ...
    model = TVAE(
        embedding_dim=embedding_dim,
        compress_dims=generator_dim,
        decompress_dims=discriminator_dim,
        epochs=10
    )
...
def merge_models(models, model_details):
    ...
    merged_model.decoder.load_state_dict(merged_state_dict)
